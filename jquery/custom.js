...
var onZoom = function() {
  ...
  if (zoomin) {
    ...
    M.util.set_user_preference('theme_even_more_zoom', 'nozoom');
  } else {
    Y.one('body').addClass('zoomin');
    M.util.set_user_preference('theme_even_more_zoom', 'zoomin');
  }
};

//When the button with class .moodlezoom is clicked fire the onZoom function
M.theme_even_more = M.theme_even_more || {};
M.theme_even_more.zoom =  {
  init: function() {
...
var onFull = function() {
    if ( $("#page").hasClass("fullin") ) {
        ...
        M.util.set_user_preference('theme_even_more_full', 'nofull');
    } else {
        $( "#page").addClass('fullin');
        //Y.one('#page').addClass('fullin');
        M.util.set_user_preference('theme_even_more_full', 'fullin');
    }
};

//When the button with class .moodlezoom is clicked fire the onZoom function
M.theme_even_more = M.theme_even_more || {};
M.theme_even_more.full =  {
  init: function() {
